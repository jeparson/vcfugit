...
vcftable<-data.table(Chromosome=lapply(cpr,'[[',1),
                     ...
                     VarType=Variants$var,Depth=outdf$TC,SupportingReads=outdf$TR,
                     PercentSupport=outdf$ReadPct,Filter=Filter$FILTER)
return(vcftable)
}
vcftable<-buildvcftable(vcffile="test_vcf_data.vcf",genome="hg19")
